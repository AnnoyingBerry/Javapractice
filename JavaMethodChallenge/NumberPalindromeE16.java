...
public class NumberPalindromeE16 {
	...
	public static boolean isPalindrome(int number){
        ...
        while (number != 0){
			...
			// - first loop -> reverse = 0 * 10 = 0
			reverse *= 10;
			System.out.println("current reverse1: " + reverse);
			// - first loop -> reverse = 0 + lastdigit = e.g. 2
			reverse += lastdigit;
			System.out.println("current reverse2: " + reverse);
            number /= 10;
            System.out.println("current reverse3: " + reverse);
